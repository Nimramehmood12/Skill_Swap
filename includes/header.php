...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold fs-3" href="/projecttrial3/index.php"><span class="skill">SKILL</span><span class="swap">SWAP</span></a>
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <li class="nav-item dropdown ms-lg-3">
                            <a class="nav-link dropdown-toggle btn btn-outline-primary px-3 text-dark" href="#" id="userDrop" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item ms-lg-3">
                            <a class="btn btn-primary fw-bold px-4 rounded-pill text-white" href="/projecttrial3/auth/login.php">Login</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>

...
<section id="home" class="hero-section text-center d-flex align-items-center" style="min-height: 90vh;">
    <div class="container">
        <h1 class="display-1 fw-bold mb-4 text-dark">Learn Anything.<br><span class="text-gradient">Teach What You Love.</span></h1>
        <p class="lead mb-5 fs-4 text-muted">Join the ultimate peer-to-peer skill exchange. <br>Trade your expertise for new knowledge, 100% free.</p>
        <?php if (!isset($_SESSION['user_id'])): ?>
            <div class="d-flex justify-content-center gap-3">
                <a href="auth/register.php" class="btn btn-primary btn-lg px-5 py-3 fw-bold shadow-lg">Start Swapping Now</a>
                <a href="#how" class="btn btn-outline-dark btn-lg px-5 py-3">How it Works</a>
            </div>
        <?php else: ?>
            <a href="user/dashboard.php" class="btn btn-primary btn-lg px-5 py-3 fw-bold shadow">Go to My Dashboard</a>
        <?php endif; ?>
    </div>
</section>
            ...
            ?>
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm p-4 text-center skill-card">
                            ...
                            <a href="sessions/request_session.php?rid=<?php echo $row['user_id']; ?>&skill_id=<?php echo $row['skill_id']; ?>" class="btn btn-primary px-4">
                                Request Swap
                            </a>
                        </div>
                    </div>
...
<section id="about" class="py-5 bg-white">
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="https://images.unsplash.com/photo-1513258496099-48168024aec0?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class="img-fluid rounded-5 shadow-lg" alt="About">
            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-7 p-5 bg-white">
                        ...
                        <form>
                            ...
                            <button type="button" class="btn btn-primary w-100 py-3 fw-bold">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
